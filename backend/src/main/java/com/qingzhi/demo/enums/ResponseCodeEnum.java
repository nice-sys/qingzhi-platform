...
public enum ResponseCodeEnum {
    ...
    /** 文件大小超限：单文件超过 100MB */
    FILE_SIZE_EXCEEDED(5001, "文件大小超限（单个文件不超过 100MB）"),
    ...
    /** 每日上传数量超限：单个用户每天最多上传 100 个文件（草稿+正式合并计数） */
    DAILY_UPLOAD_LIMIT_EXCEEDED(5006, "今日上传文件数量已达上限（每天最多 100 个），请明天再试"),

    /** 操作频繁（下载刷接口拦截，与上传频率区分独立提示） */
    OPERATION_TOO_FREQUENT(5007, "操作频繁，请稍后重试"),
